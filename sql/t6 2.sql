...
-- user_id = 1 (既存分 + 調整)
(1,'メール返信',2,'2027-04-03',25,0,'2026-01-27','仕事', TRUE),
(1,'部屋の片付け',3,'2027-04-04',40,40,'2026-01-28','生活', FALSE),
(1,'ランニング',3,'2027-03-06', 50,0,'2026-01-27','健康', TRUE),
(1,'資格試験の勉強',1,'2027-03-20',120,0,'2026-01-28','学習', TRUE),
(1,'プレゼント購入',2,'2027-04-05',30,30,'2026-01-27','プライベート', FALSE),
(1,'課題レポート下書き',2,'2027-03-16',45,45,'2026-01-27','学校', FALSE),
(1,'課題レポート清書',2,'2027-04-02',30,30,'2026-01-27','学校', FALSE),
(1,'チームMTG議事録',1,'2027-03-23',15,15,'2026-01-27','学校', FALSE),
(1,'Gitコミット整理',3,'2027-03-30',120,120,'2026-01-27','生活', FALSE),
(1,'ポートフォリオREADME更新',3,'2027-03-20',75,75,'2026-01-28','ポートフォリオ', FALSE),
(1,'studylog DB設計見直し',1,'2027-03-17',10,0,'2026-01-28','studyLog', TRUE),
(1,'studylog 画面遷移確認',2,'2027-03-20',30,30,'2026-01-28','studyLog', FALSE),
(1,'Flask ルーティング整理',3,'2027-04-01',120,120,'2026-01-28','studyLog', FALSE),
(1,'SQL初期データ作成',1,'2027-04-25',10,10,'2026-01-28','studyLog', FALSE),
(1,'Unity Raycast挙動調整',2,'2027-03-08',60,0,'2026-01-28','Unity', TRUE),
(1,'Unity UIレイアウト調整',2,'2027-04-01',60,60,'2026-01-28','Unity', FALSE),
(1,'就活ES下書き',1,'2027-04-23',20,20,'2026-01-29','就活', FALSE),
(1,'企業研究(1社)',2,'2027-04-22',45,45,'2026-01-29','就活', FALSE),
(1,'SPI対策(非言語)',2,'2027-04-07',60,0,'2026-01-29','就活', TRUE),
(1,'SPI対策(言語)',2,'2027-04-26',60,60,'2026-01-29','就活', FALSE),
(1,'面接想定質問作成',1,'2027-04-22',20,20,'2026-01-29','就活', FALSE),
(1,'自己PRブラッシュアップ',2,'2027-04-03',60,60,'2026-01-29','就活', FALSE),
(1,'ガクチカ整理',2,'2027-04-09',45,0,'2026-01-29','就活', TRUE),
(1,'学習計画作り',3,'2027-04-08',90,90,'2026-01-29','学習', FALSE),
(1,'Python基礎復習',1,'2027-04-07',10,10,'2026-01-29','学習', FALSE),
(1,'Python例外処理学習',3,'2027-04-12',120,120,'2026-01-29','学習', FALSE),
(1,'HTML/CSS微調整',2,'2027-04-21',60,60,'2026-01-29','studyLog', FALSE),
(1,'JSスライダー修正',3,'2027-04-11',90,90,'2026-01-29','studyLog', FALSE),
(1,'バグ修正: 合計時間ずれ',1,'2027-04-02',15,0,'2026-02-01','studyLog', TRUE),
(1,'タスク提案ロジック改善',2,'2027-04-15',45,45,'2026-02-01','studyLog', FALSE),
(1,'評価倍率の確認',2,'2027-04-30',45,45,'2026-02-02','studyLog', FALSE),
(1,'締切補正のテスト',2,'2027-04-04',45,45,'2026-02-02','studyLog', FALSE),
(1,'新規タスク登録UI改善',1,'2027-04-23',20,20,'2026-02-02','studyLog', FALSE),
(1,'ログイン周り確認',2,'2027-04-07',30,30,'2026-02-02','studyLog', FALSE),
(1,'パスワード変更画面',3,'2027-04-18',90,90,'2026-02-02','studyLog', FALSE),
(1,'日報テンプレ作成',1,'2027-04-09',20,20,'2026-02-02','学校', FALSE),
(1,'議事録テンプレ作成',2,'2027-04-25',45,45,'2026-02-02','学校', FALSE),
(1,'DBインデックス検討',3,'2027-04-12',120,120,'2026-02-02','studyLog', FALSE),
(1,'テストケース作成',3,'2027-04-10',90,90,'2026-02-02','studyLog', FALSE),
(1,'単体テスト追加',2,'2027-04-15',60,60,'2026-02-02','studyLog', FALSE),
(1,'コード整形',2,'2027-04-12',30,30,'2026-02-02','studyLog', FALSE),
(1,'修正: task.py',3,'2027-04-26',120,120,'2026-02-03','studyLog', FALSE),
(1,'修正: projects.py',3,'2027-04-09',120,120,'2026-02-03','studyLog', FALSE),
(1,'エラーハンドリング改善',3,'2027-04-08',90,90,'2026-02-03','studyLog', FALSE),
(1,'洗濯',1,'2027-04-18',20,20,'2026-02-03','家事', FALSE),
(1,'部屋掃除',2,'2027-04-03',45,45,'2026-02-03','家事', FALSE),
(1,'買い物(食材)',2,'2027-04-29',30,30,'2026-02-03','家事', FALSE),
(1,'自炊(作り置き)',2,'2027-04-04',45,45,'2026-02-03','家事', FALSE),
(1,'ストレッチ10分',1,'2027-04-11',10,10,'2026-02-03','健康', FALSE),
(1,'散歩20分',1,'2027-04-25',20,20,'2026-02-03','健康', FALSE),
(1,'筋トレ15分',1,'2027-04-09',15,15,'2026-02-03','健康', FALSE),
(1,'睡眠ルーティン整備',2,'2027-04-20',30,30,'2026-02-03','健康', FALSE),
(1,'家計簿',1,'2027-04-24',15,15,'2026-02-03','家事', FALSE),
(1,'メール返信(生活用)',1,'2027-04-19',15,15,'2026-02-03','生活', FALSE),
(1,'読書30分',2,'2027-04-20',30,30,'2026-02-03','学習', FALSE),
(1,'英単語20分',1,'2027-04-02',20,0,'2026-02-03','学習', TRUE),
(1,'技術記事読む',2,'2027-04-21',45,45,'2026-02-03','学習', FALSE),
(1,'下書き',2,'2027-04-28',60,60,'2026-02-03','ポートフォリオ', FALSE),
(1,'ポートフォリオ画像用意',2,'2027-04-17',45,45,'2026-02-03','ポートフォリオ', FALSE),
(1,'デモ動画撮影',3,'2027-04-12',90,90,'2026-02-03','ポートフォリオ', FALSE),
(1,'スライド作成(発表)',3,'2027-04-23',90,90,'2026-02-04','学校', FALSE),
(1,'発表練習',2,'2027-04-09',60,60,'2026-02-04','学校', FALSE),
(1,'コードレビュー依頼',1,'2027-04-08',10,10,'2026-02-04','studyLog', FALSE),
(1,'レビュー反映',2,'2027-04-04',60,60,'2026-02-04','studyLog', FALSE),
(1,'机整理',2,'2027-04-14',45,45,'2026-02-04','生活', FALSE),
(1,'バックログ優先度付け',2,'2027-04-23',45,45,'2026-02-04','studyLog', FALSE),
(1,'次プロジェクト計画',2,'2027-04-31',60,60,'2026-02-04','studyLog', FALSE),
(1,'DBテストデータ追加',3,'2027-04-08',90,90,'2026-02-04','studyLog', FALSE),
(1,'ER図更新',2,'2027-04-04',30,30,'2026-02-04','studyLog', FALSE),
(1,'API仕様メモ',2,'2027-04-20',60,60,'2026-02-04','studyLog', FALSE),
(1,'UIモック更新',2,'2027-04-09',45,45,'2026-02-04','studyLog', FALSE),
(1,'アクセシビリティ確認',2,'2027-04-26',60,60,'2026-02-04','studyLog', FALSE),
(1,'日次振り返り',3,'2027-03-10',90,0,'2026-02-20','生活', TRUE),
 
-- user_id = 2 (既存5個 + 追加10個)
(2, '仕様書レビュー', 1, '2027-04-01', 80, 0, '2026-01-26', '仕事', TRUE),
(2, '夕食の買い出し', 3, '2027-04-29', 30, 0, '2026-01-26', '生活', TRUE),
(2, 'ストレッチ', 3, '2027-04-30', 20, 20, '2026-01-26', '健康', FALSE),
(2, '英語学習', 2, '2027-04-10', 45, 0, '2026-01-27', '学習', TRUE),
(2, '家族への連絡', 2, '2027-04-31', 15, 15, '2026-01-26', 'プライベート', FALSE),
(2, '週次報告書作成', 1, '2027-03-06', 60, 60, '2026-02-20', '仕事', FALSE),
(2, 'クライアント資料修正', 2, '2027-03-10', 90, 90, '2026-02-21', '仕事', FALSE),
(2, 'プロテインの注文', 3, '2027-03-05', 10, 0, '2026-02-25', '生活', TRUE),
(2, 'ヨガ 20分', 1, '2027-03-15', 20, 20, '2026-02-25', '健康', FALSE),
(2, '基本情報 試験勉強', 1, '2027-04-15', 120, 120, '2026-02-20', '学習', FALSE),
(2, '積読解消(技術書)', 2, '2027-03-31', 180, 180, '2026-02-15', '学習', FALSE),
(2, '美容院の予約', 3, '2027-03-08', 5, 0, '2026-03-01', 'プライベート', TRUE),
(2, '新居の家具選び', 2, '2027-04-10', 60, 60, '2026-02-28', 'プライベート', FALSE),
(2, 'ポートフォリオ構成案', 1, '2027-03-20', 45, 45, '2026-03-02', '学習', FALSE),
(2, '不要なメールの整理', 3, '2027-03-05', 30, 0, '2026-03-04', '生活', TRUE),
(2, '読書タイム', 3, '2027-03-15', 270, 0, '2026-02-20', '学習', TRUE),
 
-- user_id = 3 (既存5個 + 追加10個)
(3, '資料整理', 1, '2027-04-03', 60, 0, '2026-01-27', '仕事', TRUE),
(3, '掃除', 3, '2027-04-01', 30, 0, '2026-01-26', '生活', TRUE),
(3, '筋トレ', 3, '2027-04-30', 45, 45, '2026-01-26', '健康', FALSE),
(3, 'オンライン講座受講', 1, '2027-04-12', 90, 0, '2026-01-27', '学習', TRUE),
(3, '友人と食事の予定調整', 2, '2027-04-05', 20, 20, '2026-01-26', 'プライベート', FALSE),
(3, '経費精算申請', 1, '2027-03-05', 20, 0, '2026-03-01', '仕事', TRUE),
(3, 'リーダー面談準備', 2, '2027-03-12', 45, 45, '2026-03-02', '仕事', FALSE),
(3, 'サプリメント補充', 3, '2027-03-10', 5, 5, '2026-03-04', '健康', FALSE),
(3, 'スクワット 30回', 1, '2027-03-05', 10, 0, '2026-03-05', '健康', TRUE),
(3, 'TOEICリスニング', 1, '2027-03-31', 60, 60, '2026-02-25', '学習', FALSE),
(3, 'AWS模試', 2, '2027-03-25', 100, 100, '2026-02-28', '学習', FALSE),
(3, '加湿器掃除', 3, '2027-03-07', 30, 30, '2026-03-02', '生活', FALSE),
(3, '確定申告書類準備', 1, '2027-03-15', 120, 120, '2026-02-15', '生活', FALSE),
(3, '週末キャンプ計画', 2, '2027-03-06', 40, 40, '2026-03-03', 'プライベート', FALSE),
(3, '友人への誕生日LINE', 3, '2027-03-05', 5, 0, '2026-03-05', 'プライベート', TRUE),
(3, 'ストレッチ(日課)', 3, '2027-03-10', 135, 0, '2026-02-20', '健康', TRUE);
-- 固定予定マスター
