...
(1,'課題レポート下書き',2,'2026-02-16',45,45,'2026-01-27','学校'),
(1,'課題レポート清書',2,'2026-03-02',30,30,'2026-01-27','学校'),
(1,'チームMTG議事録',1,'2026-02-23',15,15,'2026-01-27','学校'),
(1,'Gitコミット整理',3,'2026-03-30',120,120,'2026-01-27','生活'),
(1,'ポートフォリオREADME更新',3,'2026-02-20',75,75,'2026-01-28','ポートフォリオ'),
(1,'studylog DB設計見直し',1,'2026-02-17',10,10,'2026-01-28','studyLog'),
(1,'studylog 画面遷移確認',2,'2026-02-20',30,30,'2026-01-28','studyLog'),
(1,'Flask ルーティング整理',3,'2026-03-01',120,120,'2026-01-28','studyLog'),
(1,'SQL初期データ作成',1,'2026-03-25',10,10,'2026-01-28','studyLog'),
(1,'Unity Raycast挙動調整',2,'2026-03-08',60,60,'2026-01-28','Unity'),
(1,'Unity UIレイアウト調整',2,'2026-03-01',60,60,'2026-01-28','Unity'),
(1,'就活ES下書き',1,'2026-03-23',20,20,'2026-01-29','就活'),
(1,'企業研究(1社)',2,'2026-03-22',45,45,'2026-01-29','就活'),
(1,'SPI対策(非言語)',2,'2026-03-07',60,60,'2026-01-29','就活'),
(1,'SPI対策(言語)',2,'2026-02-26',60,60,'2026-01-29','就活'),
(1,'面接想定質問作成',1,'2026-03-22',20,20,'2026-01-29','就活'),
(1,'自己PRブラッシュアップ',2,'2026-03-03',60,60,'2026-01-29','就活'),
(1,'ガクチカ整理',2,'2026-03-09',45,45,'2026-01-29','就活'),
(1,'学習計画作り',3,'2026-03-08',90,90,'2026-01-29','学習'),
(1,'Python基礎復習',1,'2026-04-07',10,10,'2026-01-29','学習'),
(1,'Python例外処理学習',3,'2026-03-12',120,120,'2026-01-29','学習'),
(1,'HTML/CSS微調整',2,'2026-03-21',60,60,'2026-01-29','studyLog'),
(1,'JSスライダー修正',3,'2026-03-11',90,90,'2026-01-29','studyLog'),
(1,'バグ修正: 合計時間ずれ',1,'2026-03-02',15,15,'2026-02-01','studyLog'),
(1,'タスク提案ロジック改善',2,'2026-03-15',45,45,'2026-02-01','studyLog'),
(1,'評価倍率の確認',2,'2026-03-30',45,45,'2026-02-02','studyLog'),
(1,'締切補正のテスト',2,'2026-03-04',45,45,'2026-02-02','studyLog'),
(1,'新規タスク登録UI改善',1,'2026-03-23',20,20,'2026-02-02','studyLog'),
(1,'ログイン周り確認',2,'2026-03-07',30,30,'2026-02-02','studyLog'),
(1,'パスワード変更画面',3,'2026-03-18',90,90,'2026-02-02','studyLog'),
(1,'日報テンプレ作成',1,'2026-03-09',20,20,'2026-02-02','学校'),
(1,'議事録テンプレ作成',2,'2026-02-25',45,45,'2026-02-02','学校'),
(1,'DBインデックス検討',3,'2026-03-12',120,120,'2026-02-02','studyLog'),
(1,'テストケース作成',3,'2026-03-10',90,90,'2026-02-02','studyLog'),
(1,'単体テスト追加',2,'2026-03-15',60,60,'2026-02-02','studyLog'),
(1,'コード整形',2,'2026-03-12',30,30,'2026-02-02','studyLog'),
(1,'修正: task.py',3,'2026-03-26',120,120,'2026-02-03','studyLog'),
(1,'修正: projects.py',3,'2026-03-09',120,120,'2026-02-03','studyLog'),
(1,'エラーハンドリング改善',3,'2026-03-08',90,90,'2026-02-03','studyLog'),
(1,'洗濯',1,'2026-03-18',20,20,'2026-02-03','家事'),
(1,'部屋掃除',2,'2026-03-03',45,45,'2026-02-03','家事'),
(1,'買い物(食材)',2,'2026-03-29',30,30,'2026-02-03','家事'),
(1,'自炊(作り置き)',2,'2026-04-04',45,45,'2026-02-03','家事'),
(1,'ストレッチ10分',1,'2026-03-11',10,10,'2026-02-03','健康'),
(1,'散歩20分',1,'2026-02-25',20,20,'2026-02-03','健康'),
(1,'筋トレ15分',1,'2026-03-09',15,15,'2026-02-03','健康'),
(1,'睡眠ルーティン整備',2,'2026-03-20',30,30,'2026-02-03','健康'),
(1,'家計簿',1,'2026-03-24',15,15,'2026-02-03','家事'),
(1,'メール返信',1,'2026-03-19',15,15,'2026-02-03','生活'),
(1,'読書30分',2,'2026-03-20',30,30,'2026-02-03','学習'),
(1,'英単語20分',1,'2026-04-02',20,20,'2026-02-03','学習'),
(1,'技術記事読む',2,'2026-03-21',45,45,'2026-02-03','学習'),
(1,'下書き',2,'2026-03-28',60,60,'2026-02-03','ポートフォリオ'),
(1,'ポートフォリオ画像用意',2,'2026-02-17',45,45,'2026-02-03','ポートフォリオ'),
(1,'デモ動画撮影',3,'2026-03-12',90,90,'2026-02-03','ポートフォリオ'),
(1,'スライド作成(発表)',3,'2026-03-23',90,90,'2026-02-04','学校'),
(1,'発表練習',2,'2026-03-09',60,60,'2026-02-04','学校'),
(1,'コードレビュー依頼',1,'2026-03-08',10,10,'2026-02-04','studyLog'),
(1,'レビュー反映',2,'2026-04-04',60,60,'2026-02-04','studyLog'),
(1,'机整理',2,'2026-03-14',45,45,'2026-02-04','生活'),
(1,'バックログ優先度付け',2,'2026-02-23',45,45,'2026-02-04','studyLog'),
(1,'次プロジェクト計画',2,'2026-03-31',60,60,'2026-02-04','studyLog'),
(1,'DBテストデータ追加',3,'2026-03-08',90,90,'2026-02-04','studyLog'),
(1,'ER図更新',2,'2026-03-04',30,30,'2026-02-04','studyLog'),
(1,'API仕様メモ',2,'2026-03-20',60,60,'2026-02-04','studyLog'),
(1,'UIモック更新',2,'2026-03-09',45,45,'2026-02-04','studyLog'),
(1,'アクセシビリティ確認',2,'2026-03-26',60,60,'2026-02-04','studyLog'),
-- user_id = 2
