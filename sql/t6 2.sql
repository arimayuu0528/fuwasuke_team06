...
(1,'2026-03-05 08:00:00','悪い',1),
(2,'2026-03-05 08:00:00','普通',2),
(3,'2026-03-05 08:00:00','元気',3);


-- タスク作業ログ
INSERT INTO t_task_work_logs (task_id, work_date, work_min, start_time, end_time) VALUES
-- 2/25 (水)
(3,  '2026-02-25', 50, '18:00:00', '18:50:00'), -- User1: ランニング完了
(73, '2026-02-25', 80, '10:00:00', '11:20:00'), -- User2: 仕様書レビュー完了
(79, '2026-02-25', 30, '09:00:00', '09:30:00'), -- User3: 掃除完了

-- 2/26 (木)
(11, '2026-02-26', 10, '09:00:00', '09:10:00'), -- User1: DB設計完了
(74, '2026-02-26', 30, '17:00:00', '17:30:00'), -- User2: 買い出し完了
(78, '2026-02-26', 30, '14:00:00', '14:30:00'), -- User3: 資料整理(1回目)

-- 2/27 (金)
(15, '2026-02-27', 60, '20:00:00', '21:00:00'), -- User1: Unity調整完了
(76, '2026-02-27', 30, '08:00:00', '08:30:00'), -- User2: 英語(継続)
(78, '2026-02-27', 30, '10:00:00', '10:30:00'), -- User3: 資料整理完了

-- 2/28 (土)
(4,  '2026-02-28', 60, '14:00:00', '15:00:00'), -- User1: 資格勉強(1回目)
(76, '2026-02-28', 15, '09:00:00', '09:15:00'), -- User2: 英語(合計45分だがFALSEのまま設定)
(81, '2026-02-28', 30, '21:00:00', '21:30:00'), -- User3: オンライン講座(1回目)

-- 3/1 (日)
(56, '2026-03-01', 20, '08:00:00', '08:20:00'), -- User1: 英単語完了
(73, '2026-03-01', 30, '20:00:00', '20:30:00'), -- User2: (予備ログ: 追加作業)
(81, '2026-03-01', 30, '10:00:00', '10:30:00'), -- User3: オンライン講座(2回目)

-- 3/2 (月)
(29, '2026-03-02', 15, '11:00:00', '11:15:00'), -- User1: バグ修正完了
(74, '2026-03-02', 15, '18:00:00', '18:15:00'), -- User2: 買い出し(追加分)
(78, '2026-03-02', 20, '13:00:00', '13:20:00'), -- User3: 資料整理(追加分)

-- 3/3 (火)
(19, '2026-03-03', 30, '20:00:00', '20:30:00'), -- User1: SPI対策(継続)
(76, '2026-03-03', 20, '08:00:00', '08:20:00'), -- User2: 英語
(81, '2026-03-03', 30, '21:00:00', '21:30:00'), -- User3: オンライン講座(3回目)

-- 3/4 (水)
(23, '2026-03-04', 45, '13:00:00', '13:45:00'), -- User1: ガクチカ整理完了
(73, '2026-03-04', 40, '10:00:00', '10:40:00'), -- User2: 仕様書(追加)
(79, '2026-03-04', 30, '09:00:00', '09:30:00'), -- User3: 掃除(定期)

-- 3/5 (木)
(1,  '2026-03-05', 25, '09:00:00', '09:25:00'), -- User1: メール返信完了
(4,  '2026-03-05', 60, '22:00:00', '23:00:00'), -- User1: 資格勉強完了(計120分)
(76, '2026-03-05', 30, '08:00:00', '08:30:00'), -- User2: 英語
(81, '2026-03-05', 60, '20:00:00', '21:00:00'); -- User3: オンライン講座
